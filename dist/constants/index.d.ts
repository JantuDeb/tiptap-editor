...
export declare const DEFAULT_FONT_SIZE_LIST: readonly ["Default", "10px", "11px", "12px", "14px", "16px", "18px", "20px", "22px", "24px", "26px", "28px", "36px", "48px", "72px"];
...
export declare const HEADINGS: (string | number)[];
